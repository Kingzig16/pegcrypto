...
export 'contactsupport_model.dart';
                                ...
                                Expanded(
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        FFLocalizations.of(context).getText(
                                          't889ey9g' /* pegdwendeechange@gmail.com */,
                                        ),
                                        style: FlutterFlowTheme.of(context)
                                            .bodyMedium
                                            .override(
                                ...
                                Expanded(
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        FFLocalizations.of(context).getText(
                                          'f5jzo20l' /* Koupela,secteur 4, Burkina Fas... */,
                                        ),
                                        style: FlutterFlowTheme.of(context)
                                            .bodyMedium
                                            .override(
                              ...
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: InkWell(
                                    ...
                                    onTap: () async {
                                      await launchURL(
                                          'https://instagram.com/pegdwendeall?igshid=OGQ5ZDc2ODk2ZA==');
                                    },
                                    child: Column(
                                      mainAxisSize: MainAxisSize.max,
                                      mainAxisAlignment:
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            TextFormField(
                              ...
                              decoration: InputDecoration(
                                hintText: FFLocalizations.of(context).getText(
                                  'pqdr8rms' /* Décrivez votre problème */,
                                ),
                                hintStyle: FlutterFlowTheme.of(context)
                                    .bodySmall
                                    .override(
