...
class GetaffiliationuserStruct extends BaseStruct {
  ...
  static GetaffiliationuserStruct fromMap(Map<String, dynamic> data) =>
      GetaffiliationuserStruct(
  ...
  static GetaffiliationuserStruct? maybeFromMap(dynamic data) => data is Map
      ? GetaffiliationuserStruct.fromMap(data.cast<String, dynamic>())
      : null;
  ...
  static GetaffiliationuserStruct fromSerializableMap(
  ...
  @override
  String toString() => 'GetaffiliationuserStruct(${toMap()})';

  @override
  bool operator ==(Object other) {
    return other is GetaffiliationuserStruct &&
        id == other.id &&
        nom == other.nom &&
...
GetaffiliationuserStruct createGetaffiliationuserStruct({
  int? id,
  String? nom,
  String? prenoms,
  String? email,
