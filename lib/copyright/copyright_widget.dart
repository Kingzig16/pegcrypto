...
export 'copyright_model.dart';

class CopyrightWidget extends StatefulWidget {
  const CopyrightWidget({super.key});

  static String routeName = 'copyright';
  static String routePath = 'copyright';
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: Text(
                            FFLocalizations.of(context).getText(
                              'vgoxdbmp' /* Copyright Information */,
                            ),
                        ...
                        Padding(
                          ...
                          child: Text(
                            FFLocalizations.of(context).getText(
                              'bbjtkywr' /* © PEGDWENDE ECHANGE, All Right... */,
                            ),
                            style:
                        ...
                        Padding(
                          ...
                          child: Text(
                            FFLocalizations.of(context).getText(
                              'knwta57k' /* Tous droits réservés. Aucune p... */,
                            ),
                            style: FlutterFlowTheme.of(context)
                                .bodyMedium
                                .override(
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    FFLocalizations.of(context).getText(
                                      'i1lt39eh' /* Toutes les marques commerciale... */,
                                    ),
                                    style: FlutterFlowTheme.of(context)
                                        .bodyMedium
                                        .override(
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    FFLocalizations.of(context).getText(
                                      'fkn7ew5j' /* Certains contenus de cette app... */,
                                    ),
                                    style: FlutterFlowTheme.of(context)
                                        .bodyMedium
                                        .override(
