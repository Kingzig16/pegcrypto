...
class PubliciteWidget extends StatefulWidget {
  ...
  static String routeName = 'publicite';
  static String routePath = 'publicite';
              ...
              children: [
                ...
                FutureBuilder<ApiCallResponse>(
                  ...
                  builder: (context, snapshot) {
                    ...
                    final listViewGetAllPubApiV1PubGetResponse = snapshot.data!;

                    return Builder(
                      builder: (context) {
                        final pub = getJsonField(
                          listViewGetAllPubApiV1PubGetResponse.jsonBody,
                          r'''$.data''',
                        ).toList();
                                                                ...
                                                                onPressed:
                                                                  ...
                                                                  context
                                                                    ...
                                                                    queryParameters:
                                                                      ...
                                                                      'titre':
                                                                          serializeParam(
                                                                        PubliciteStruct.maybeFromMap(pubItem)
                                                                            ?.title,
                                                                        ParamType
                                                                            .String,
                                                                      ),
                                                                    ...
                                                                    await showDialog<
                                                                          ...
                                                                          builder:
                                                                            ...
                                                                            return AlertDialog(
                                                                              ...
                                                                              content: Text('Voulez vous supprimer cette pub ?'),
                                                                              actions: [
                                                                                TextButton(
                                                                ...
                                                                if (confirmDialogResponse) {
                                                                  _model.apiResult8m5 =
                                                                      await PegdwendeExchangeApiGroup
                                                                          ...
                                                                          .call(
                                                                    id: PubliciteStruct.maybeFromMap(
                                                                            pubItem)
                                                                        ?.id,
                                                                  );
